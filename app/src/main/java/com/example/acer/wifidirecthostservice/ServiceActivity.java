    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.atn_direct_discover:
                if (!isWifiP2pEnabled) {
                    Toast.makeText(ServiceActivity.this, R.string.p2p_off_warning,
                ...
                manager.discoverPeers(channel, new WifiP2pManager.ActionListener() {
                    ...
                    public void onSuccess() {
                        Toast.makeText(ServiceActivity.this, "Discovery Initiated",
                                Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(int reasonCode) {
                        Toast.makeText(ServiceActivity.this, "Discovery Failed : " + reasonCode,
                                Toast.LENGTH_SHORT).show();
                    }
                });
                return true;
            case R.id.atn_screen:
                startActivity(new Intent(this, RemoteScreen.class));
            default:
    ...
    public void connect(WifiP2pConfig config) {
        ...
        manager.connect(channel, config, new WifiP2pManager.ActionListener() {
            ...
            public void onFailure(int reason) {
                Toast.makeText(ServiceActivity.this, "Connect failed. Retry.",
                        Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        if (manager != null) {
            ...
            if (fragment.getDevice() == null
                ...
                manager.cancelConnect(channel, new WifiP2pManager.ActionListener() {
                    ...
                    @Override
                    public void onSuccess() {
                        Toast.makeText(ServiceActivity.this, "Aborting connection",
                                Toast.LENGTH_SHORT).show();
                    }
